...
def main():
    ...
    for fold, (train_indices, test_indices) in enumerate(stratified_kfold.split(train_features, train_labels)):
        ...
        lgb_classifier.fit(fold_train_features, fold_train_labels)

        fold_predictions = lgb_classifier.predict(fold_test_features)
        fold_probabilities = lgb_classifier.predict_proba(fold_test_features)
