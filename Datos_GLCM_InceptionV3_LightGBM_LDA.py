...
def extract_features(image):
    ...
    # InceptionV3 ve GLCM özelliklerini birleştir
    combined_features = np.concatenate((inception_features, glcm_features))
...
def main():
    ...
    ica = FastICA(n_components=100, random_state=42)  # 100 bileşene indir
